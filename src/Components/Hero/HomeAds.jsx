...
function HomeAds() {
  return (
    <div className="container grid grid-cols-3 max-[639px]:flex flex-col  sm:bg-yellow-50 xl:h-[250px] lg:h-[190px] md:h-[150px] md:w-full lg:w-full items-center md:shadow-xl max-[639px]:mb-10 max-[639px]:mt-10  mb-10">
        <div className=' flex items-center justify-center lg:space-x-6 md:border-r-2 md:pl-3 lg:pr-2 md:border-gray-950 sm:space-x-3 max-[639px]:space-x-3 max-[639px]:w-[80%] max-[639px]:mb-3 max-[639px]:w-[70%] max-[639px]:mx-auto max-[639px]:shadow-xl'>
        ...
        <div className=' flex items-center justify-center md:space-x-4 sm:space-x-3 md:pl-2 lg:pr-3 space-x-3 sm:border-r-2 md:border-gray-950 max-[639px]:mb-3 max-[639px]:w-[80%] max-[639px]:mt-6 max-[639px]:w-[70%] max-[639px]:mx-auto max-[639px]:shadow-xl'>
