        ...
        <div className='absolute text-center bottom-12 w-full'>
          ...
          <div className='w-full'>
            <div className='flex items-center justify-center'>
              <Link
                to='/sign'
                className='p-3 rounded-xl 2xl:text-md sm:text-md sm:w-3/3  lg:text-md text-center md:w-3/3 shadow-xl md:text-sm block lg:w-1/3 hover:text-[#fff565] bg-[#9ffc41]  hover:scale-105 duration-150'
              >
                Sign up here
              </Link>
            </div>
