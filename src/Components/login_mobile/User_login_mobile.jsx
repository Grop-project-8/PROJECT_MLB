  ...
  return (
    <div class="grid justify-center sm:max md:disabled: gap-4" >
      ...
      <AiOutlineArrowLeft  className='absolute inline-block  top-0 left-0 bg-white'/>
       ...
       <div>
        <input type="text" name="" id="" placeholder='  user name' className='h-[50px] border-2 border-slate-900 w-full  rounded-lg'/>
       </div>
       <div >
        <input type="text" name="" id="" placeholder='  password' className='h-[50px] border-2 border-slate-900 w-full  rounded-lg'/>
       </div>
