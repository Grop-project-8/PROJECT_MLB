...
import {Link} from 'react-router-dom'
 ...
 const Yoga = () => {
  ...
  const filtertype = allVideo.filter(video => video.type === "yoga");
  ...
  return (
    <>
      ...
      /><div className=' flex justify-center items-center 2xl:text-2xl xl:text-xl lg:text-lg text-sm'><h1>Yoga</h1></div>
