...
import {Link} from 'react-router-dom'
 ...
 const BodyWeight = () => {
  ...
  const filtertype = allVideo.filter(video => video.type === "bodyWeight");
  ...
  return (
    <>
      ...
      />
    <div className=' flex justify-center items-center 2xl:text-2xl xl:text-xl lg:text-lg text-sm'><h1>Body weight</h1></div>
